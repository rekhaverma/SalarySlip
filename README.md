##Steps to use Salary calculator:

Instructions to run this App.

1. Clone the repo `https://github.com/rekhaverma/SalarySlip.git`.
2. Go to client directory and run npm install.
3. Start server by writin `npm start`.
4. Open new tab.
4. Now come out of client folder.
5. Run npm install.
6. run npm start.
